            ...
            <span className="flex col-span-4 mt-2 sm:mt-auto sm:justify-end">
                      <nav aria-label="Table navigation">
                        <ul className="inline-flex items-center">
                          ...
                          <li>
                            <button
                              className="px-3 py-1 text-white transition-colors duration-150 bg-cyan-600 border border-r-0 border-cyan-600 rounded-md focus:outline-none focus:shadow-outline-cyan">
                              3
                            </button>
                          </li>
                          <li>
        ...
        <div className="grid gap-6 mb-8 md:grid-cols-2">
          <div className="min-w-0 p-4 bg-white rounded-lg shadow-xs dark:bg-gray-800">
            ...
            <div className="flex justify-center mt-4 space-x-3 text-sm text-gray-600 dark:text-gray-400">
              ...
              <div className="flex items-center">
                <span className="inline-block w-3 h-3 mr-1 bg-cyan-600 rounded-full" />
                <span>Bags</span>
              </div>
            </div>
          </div>
