...
const HeroSection = () => {
  ...
  return (
    <div className="overflow-hidden lg:relative lg:py-28">
      <div className="mx-auto max-w-md px-4 sm:max-w-3xl sm:px-6 lg:grid lg:max-w-7xl lg:grid-cols-2 lg:gap-24 lg:px-8 sm:flex sm:flex-col sm:items-center">
        <div>
          <div>
        ...
        <div className="relative lg:pl-12">
          <img
            className="w-1/2  lg:h-full lg:w-full"
            src={investImage}
            alt=""
          />
        </div>
