...
import loginVector from "../../../../assets/imgs/vectors/login.svg";

const login = () => {
    return(
            <div className="flex min-h-full">
                <div className="flex flex-1 flex-col justify-center py-6 px-4 sm:px-6 lg:flex-none lg:px-20 xl:px-24">
                    <div className="mx-auto w-full max-w-sm lg:w-96">
                        <div>
                            <img className="h-24 w-36"
                                 src={logo}
                                 alt="Your Company"/>
                            <h2 className="mt-2 lg:text-3xl font-bold text-xl tracking-tight text-gray-900">
                                ...
                                <form action="#" method="POST" className="space-y-3">
                                    ...
                                    <div className="flex items-center justify-between">
                                        ...
                                        <div className="text-sm">
                                            <a href="#" className="font-medium text-cyan-600 hover:text-cyan-500">Forgot
                                                your password?</a>
                                        </div>
                                    </div>
                                    ...
                                    <div className="space-y-1">
                                        <button type="submit"
                                                className="flex w-full justify-center rounded-md border border-transparent bg-cyan-600 py-2 px-4 text-sm font-medium text-white shadow-sm hover:bg-cyan-700 ">Se Connecter
                                        </button>
                                        <Link
                                            to="/"
