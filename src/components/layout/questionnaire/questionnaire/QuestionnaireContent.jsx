      ...
      {result ? (
        <div className="m-2 bg-gray-50 rounded-lg">
          ...
          <div className="flex flex-col sm:flex-row sm:space-x-2 space-y-2 sm:space-y-0 items-center justify-center px-4 sm:px-12">
            ...
            {/!*When i click on this button i wanna see the models not direclty in the page*!/}
            <Button
              onClick={() => setOpenModal(true)}
              className="w-full sm:w-1/2 flex items-center justify-center rounded-md border border-transparent bg-cyan-600 py-1.5 px-8 text-base font-medium text-white hover:bg-cyan-800 focus:outline-none focus:ring-2"
            >
