    ...
    import { FDG_ANUUEL, FRAIS_MENSUEL_ABONNEMENT, investNetFraisTotalCalc, fraisCalc, tauxNetHebdoCalc, TAUX_RENDEMENT_MOYEN, FDG_ANUUEL_OPVCM, TAUX_RENDEMENT_MOYEN_OPVCM, investNetFraisTotal_OPVCM_Calc, investNetFraisTotal_CompteCarnet_Calc, TAUX_RENDEMENT_MOYEN_COMPTE_CARNET, FDG_ANUUEL_COMPTE_CARNET } from '../../../../utils/hero/calculator/calculator'
        ...
        return (
            ...
            <div className="bg-white">
                <div
                    ...
                    <div>
                        <h2 className="text-2xl font-bold tracking-tight text-gray-900 sm:text-3xl">Liberté financière
                            ou travail à vie : Quel choix pour votre avenir?</h2>
                        <p className="mt-4 text-gray-500">Découvrez l'impact concret de Hikma Invest sur
                            l'investissement financier à travers cet exemple.</p>
                        ...
                        <dl className="mt-16 grid grid-cols-1 gap-x-6 gap-y-10 sm:grid-cols-2 sm:gap-y-16 lg:gap-x-8">
                            ...
                            <div className="border-t border-gray-200 pt-4">
                                ...
                                <dd className="mt-2 font-medium text-gray-500">{compteCarnet} MAD</dd>
                            </div>
