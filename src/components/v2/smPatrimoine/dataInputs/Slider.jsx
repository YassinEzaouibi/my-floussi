...
export default function Sider({ min, max, title, t1, t2, v, montant, step, unit, setV }) {
    ...
    return (
        <div className='smp-Slider my-3 py-2'>
            <Box sx={{ width: '100%', marginTop: 2 }}>
                <h5 className=' text-grayLight text-left mb-1 opacity-80 text-sm font-light'>{title}</h5>
                {montant ?
