...
import TopParagraphe from './TopParagraphe'
...
import { revenuMensuelCalc, valeurFutureCalc, valeurNetteCalc } from '../../../../utils/smPatrimoine/revenueNette';
import { useDispatch } from 'react-redux';
import { useSelector } from 'react-redux';
import { plusValueBrutteCalc, plusValueNetteCalc } from '../../../../utils/smPatrimoine/plusValue';
import GraphYearsIndicator from './GraphYearsIndicator';
import GraphColorsIndicator from './GraphColorsIndicator';
import MainParagraphe from './MainParagraphe';
...
const Index = () => {
    ...
    const { repInv, repPI, pActuel, invAnnuel,
        ...
        txRetrait, txInflation, smPatrimoineData
    ...
    useEffect(() => {
        ...
        const valeurFuture = valeurFutureCalc(pActuel, pmvBourse, pmvAutre, versementCumule)
        ...
        const plusValueBrutte = plusValueBrutteCalc(valeurFuture, pActuel, versementCumule)
