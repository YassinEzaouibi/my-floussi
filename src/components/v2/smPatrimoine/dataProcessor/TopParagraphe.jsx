    ...
    return (
        <div className=' w-[80%] mx-auto my-14'>
            <p className=' text-black text-center text-sm font-light '>
                ...
                passif de <span className='text-lg font-bold'> {addSpacesToNumber(revenuParMois)} </span> MAD/mois pour un capital final de
                <span className='text-lg font-bold'> {addSpacesToNumber(capitalFinal)} </span> MAD
            </p>
        </div>
    )
}
