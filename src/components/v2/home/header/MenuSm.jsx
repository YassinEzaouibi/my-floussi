...
const MenuSm = () => {
    return (
        <ul
            ...
            <li className=' opacity-80 h-full w-fit  ease-in-out transition-all duration-300 hover:opacity-100 '><Link to={'/calculateur_de_budget'}>Calculateur de budget</Link>
            </li>
            <li className=' opacity-80 h-full w-fit  ease-in-out transition-all duration-300 hover:opacity-100 '><Link to={'/simulateur_de_patrimoine'}>Simulateur de patrimoine</Link>
            </li>
        </ul>
    )
}
