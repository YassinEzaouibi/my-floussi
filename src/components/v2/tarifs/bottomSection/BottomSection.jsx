...
const BottomSection = () => {
    return (
        <div className=' w-[80%] p-10 mx-auto bg-bodyLight rounded-md shadow-md my-10 flex-col lg:flex-row flex  gap-5'>
            ...
            <div className=' flex flex-col justify-center'>
                ...
                <div className=' flex-col lg:flex-row flex gap-10 h-fit'>
                    <button className=' bg-mainLight text-white text-center text-md lg:text-lg px-5 py-5 transition-all duration-300 capitalize rounded-md hover:bg-darkBlue'>
