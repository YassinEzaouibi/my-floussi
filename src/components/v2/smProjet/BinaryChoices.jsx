...
import { setBinarySelected, setTempUserResponses, setUserHasSelectedChoice } from '../../../redux/smProjectSlice'
...
const BinaryChoices = ({ onError, choices, setShow, question }) => {
    ...
    const selected = useSelector(state => state.smProjetQuestionnaire.selectedBinary)
