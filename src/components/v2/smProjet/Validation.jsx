...
import { pushResponse, refreshSliders, setUserHasSelectedChoice, clearTempUserResponses } from '../../../redux/smProjectSlice';

const Validation = () => {

    const { tempUserResponses, userResponses } = useSelector(state => state.smProjetQuestionnaire)
    // console.log(userResponses)

    const dispatch = useDispatch()
    const pass = useSelector(state => state.smProjetQuestionnaire.userHasSelectedChoice)
