...
import { setChoiceIsSelected, setTempUserResponses, setUserHasSelectedChoice } from '../../../redux/smProjectSlice'
            ...
            <div className='w-full'>
                {
                    choices.map((c, i) => (
                        <div
                            style={{ backgroundColor: c.isSelected === true ? '#AACEEC' : '#fff' }}
                            onClick={() => {
                                selectChoice(c.id)
                                setScore(i + 1)
                                setResponse(c.name)
