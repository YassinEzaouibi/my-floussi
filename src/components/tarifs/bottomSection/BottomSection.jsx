...
const BottomSection = () => {
  ...
  return (
    <div
      data-aos="fade-right"
      className=" w-[80%] p-10 mx-auto bg-gray-200 rounded-md shadow-md my-10 flex-col lg:flex-row flex  gap-5"
    >
      ...
      <div className=" flex flex-col justify-center">
        <p className=" max-w-[80%] text-grayLight my-5">
          Votre recommandation sur mesure en moins de 2 minutes : simple,
          rapide, efficace
        </p>

        <div className=" flex-col lg:flex-row flex gap-10 h-fit">
          <Link
            to="/simulateur_de_projet"
            className=" bg-mainLight text-white text-center text-md lg:text-lg px-5 py-5 transition-all duration-300 capitalize rounded-md hover:bg-darkBlue"
          >
        ...
        <p className=" italic text-sm max-w-[80%] text-grayLight my-5">
          Attention : Risque de perte en capital avec les supports
          d'investissement.
        </p>
      </div>
    </div>
