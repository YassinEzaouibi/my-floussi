        ...
        questions: [
            {
                ...
                instruction: "Vous n'aurez pas la même capacité de d'épargne selon votre situation familiale et maritale.",
                choices: [
                    {
                        id: uuid(),
                        name: 'Célibataire',
...

            {
                ...
                instruction: "Avoir des enfants implique des dépenses en plus, cela nous permet d'estimer votre capacité d'épargne.",
                choices: [
                    {
                        id: uuid(),
                        name: 'aucun'
